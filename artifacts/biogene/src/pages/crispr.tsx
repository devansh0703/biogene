...
export default function Crispr() {
  ...
  const { refetch: fetchSeq } = useGetGeneSequence(
    geneName,
    { species },
    { query: { enabled: false } }
  );
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground font-mono mt-1 text-sm">
          Cas9 guide RNA design with PAM detection, GC scoring, off-target prediction
        </p>
      </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div>
                ...
                >
                  ...
                  <option value="NNNRRT">NNNRRT (SaCas9 KKH)</option>
                  <option value="TTTV">TTTV (AsCpf1)</option>
                  <option value="TTN">TTN (FnCpf1)</option>
                </select>
              </div>
              <div>
        ...
        <Card className="rounded-none border-border bg-card">
          <CardHeader>
            <CardTitle className="text-sm uppercase flex items-center justify-between flex-wrap gap-2">
              ...
              <span className="text-xs text-muted-foreground font-mono">{result.sequenceLength.toLocaleString()} bp analyzed</span>
            </CardTitle>
          </CardHeader>
          <CardContent>
